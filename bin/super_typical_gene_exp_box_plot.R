...
boxplot(exp~group,data=boxdata,outline =F,col=c("#FF6600","grey"),boxwex=0.2,par(las="2"),bty="l",xlab = NA,ylab = "Gene expression",cex.axis=1,cex.lab=1.2,at=c(2,1),main=paste("PValue:", signif(p,4)),cex.main=1)
dev.off()
